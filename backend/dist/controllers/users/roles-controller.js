...
const newRolePOST = (request, response) => {
    ...
    try {
        mssql_1.default
            .connect(config)
            .then((pool) => {
            const query = `INSERT INTO ${roles_model_1.RolesEnum.NOM_TABLE} (${roles_model_1.RolesEnum.LIBELLE}, ${roles_model_1.RolesEnum.DROITS}) VALUES ('${sqlBody.libelleRole}', '${sqlBody.droits}')`;
